                ...
                <div className="overflow-x-auto">
                    {activeTab === 'contact' ? (
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-white/5 border-b border-white/10">
                                    <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Sender Identity</th>
                                    <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Message Content</th>
                                    <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Timestamp</th>
                            ...
                            <tbody className="divide-y divide-white/5">
                                {filteredContact.map((inq) => (
                                    <tr key={inq._id} className={`hover:bg-white/5 transition-colors group ${!inq.isRead ? 'bg-emerald-500/5' : ''}`}>
                                        ...
                                        <td className="px-8 py-4 max-w-sm">
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="bg-white/5 border-b border-white/10">
                                    <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Applicant Node</th>
                                    <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Professional Path</th>
                                    <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400">Timestamp</th>
                                    <th className="px-8 py-4 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-400 text-right">Actions</th>
                                </tr>
                            </thead>
