                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:items-center lg:justify-between relative z-10">
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            ...
                            <h2 className="text-2xl font-black text-white tracking-tighter uppercase">Timeline Architecture</h2>
                        ...
                        <p className="text-slate-400 font-medium text-xs">Corporate trajectory and historical milestone management.</p>
                    </div>
                                ...
                                >
                                    <td className="px-8 py-4">
                                        <div className="flex items-center gap-2.5">
                                            ...
                                            <span className="font-black text-white text-[14px] tracking-widest">{milestone.year}</span>
                                        </div>
                                    </td>
                                    <td className="px-8 py-4 max-w-xl">
                                        <div>
                                            <div className="font-bold text-white text-[14px] tracking-tight">{milestone.title}</div>
                                            <p className="text-slate-400 text-[11px] mt-0.5 leading-relaxed font-medium line-clamp-1">{milestone.description}</p>
                                        </div>
                                    </td>
